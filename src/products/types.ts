...
export interface Product {
    ...
    active: boolean;
    deleted: boolean;
    media: { distance: string; isVideo: boolean; type: string; url: string; description: string}[];
    created: Timestamp;
    rating: number;
    seller_name: string;
    seller_id: string;
    ...
    specs_rental: {
        ...
        width: number
        height: number
        notable_campaigns: {image_url: string; caption: string; uploaded_date: Timestamp }[]
        illumination: {
            bottom_count: number
            upper_count: number
            left_count: number
